...
export default function ReportPanel() {
  ...
  useEffect(() => {
    ...
    // eslint-disable-next-line react-hooks/set-state-in-effect -- intentional: fetch triggers loading state
    ...
    for (const msg of batch) {
      if (msg.type === "event" && msg.data) {
        ...
        if (d.agent === "reporter" && d.event_type === "agent_completed") {
          ...
          // eslint-disable-next-line react-hooks/set-state-in-effect -- intentional: reporter completion triggers refresh
          loadReports(proj);
        }
      }
    }
