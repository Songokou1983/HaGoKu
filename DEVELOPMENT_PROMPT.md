...
> ⚠️ **归档说明**（2026-07-24）：本文档部分内容撰写于 4-agent 架构时期，引用的 `_scout_reply_is_pure_confirm`、`scout/knowledge.py` 等路径/函数已删除。分析已合并到单一 `DataAnalystAgent`。本文档保留作为路线图参考，代码路径已不适用。
